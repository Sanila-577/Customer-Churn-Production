...
from src.model_building import LogisticRegressionModelBuilder
...
def training_pipeline(
    ...
    model_builder = LogisticRegressionModelBuilder(**model_params)
    ...
    evaluator = ModelEvaluator(model, 'LogisticRegression')
    ...
    create_model_performance_visualizations(
        ...
        run_artifacts_dir, 'LogisticRegression'
    )
    
    # Log model metadata
    model_config = get_model_config()['model_params']
    log_model_metadata(model, 'LogisticRegression', model_config, training_time, run_artifacts_dir)
